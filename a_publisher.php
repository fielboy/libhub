...
<head>
    ...
    <title>Library Hub | Book Publishers</title>
...
<body>
    ...
    <div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <section class="Dashboard">
                <div class="container">
                    <h4 class="m-2">Book Publishers</h4>
                    <button id="openAddPublisherModal" class="btn  btn-sm btn-secondary mx-2">Add Publisher</button>
                    <div class="modal fade" id="addPublisherModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-muted" id="exampleModalLabel">Publisher Information</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="add_publisher.php" method="POST" class="row g-3">
                                        <div class="col-md-6">
                                        <input type="text" id="publisherName" name="publisherName" class="form-control" placeholder="Publisher Name" required>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="date" id="createDate" name="createDate" class="form-control" placeholder="Create Date" required>
                                        </div>
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-sm btn-primary">Add Publisher</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <!-- Table for displaying publishers -->
                        ...
                        <table id="example1" class="custom-table">
                            ...
                            if ($result && mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>";
                                    echo "<button class='btn btn-sm px-2 btn-primary mx-2 edit-publisher-btn' data-publisher-id='".$row['PublisherID']."' data-toggle='modal' data-target='#editPublisherModal'>Edit</button>";
                                    echo "<button class='btn btn-sm btn-danger delete-publisher-btn' data-publisher-id='".$row['PublisherID']."'>Delete</button>";
                                    echo "</td>";
                                    echo "</tr>";
                                }
                            } else {
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#openAddPublisherModal').click(function () {
